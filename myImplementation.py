...
class PrivateKey: # i believe this class is meant to store private key specifically for the ECDSA with secp256k1 [see the hex method]
  ...
  def hex(self):
    ...
    # i believe this is bc the secret, which in ECDSA wtih secp256k1 is a scalar multiple of G, is thus [0, n-1]
